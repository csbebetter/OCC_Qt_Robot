...
public:
    ...
    {
        Assemly_Node* node = this->appendChild(ParentNode->parent);
        node->data = data;
        return node;
        /*return  nullptr;*/
    }
    ...
    {
        Assemly_Node* Root = new Assemly_Node;
        Root->parent = 0;
        Root->childFirst = 0;
        Root->childLast = 0;
        Root->siblingNext = 0;
        Root->siblingPrevious = 0;
        return Root;
        /*return  nullptr;*/
    }
                     ...
                     TopLoc_Location Location)
{
    ...
    Label.FindAttribute(TDataStd_Name::GetID(), attrName);
    TCollection_ExtendedString extString = attrName->Get();
    data.name = TCollection_ExtendedStringTochars(extString);
    data.typeName = ShapeTool->get_type_name();
    return  data;
}
              ...
              Assemly_Tree & Tree)
{
    ...
    {
        qDebug() << "MakeTree_components:" << components.Length();
